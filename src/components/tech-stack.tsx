const categories = [
  {
    name: "Languages",
    items: ["JavaScript", "TypeScript", "Python", "Go", "PHP", "Lua", "Bash"],
  },
  {
    name: "Web & Runtime",
    items: [
  ...
  {
    name: "Data & Storage",
    items: ["PostgreSQL", "MySQL", "SQLite", "MongoDB", "Redis", "PlanetScale"],
  },
  {
    name: "Cloud & Infra",
    items: [
  ...
  {
    name: "APIs & Protocols",
    items: ["WebSocket", "GraphQL", "tRPC", "REST", "Postman", "Kafka"],
  },
  {
    name: "Workflow",
    items: ["Neovim", "tmux", "fish", "Git", "Lazygit", "Lazydocker", "Fedora"],
  },
];
